...
export Customized_Information="AutoBuild Firmware Compiled By @waynesg build $(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
...
#菜单调整
sed -i 's/\"services\"/\"nas\"/g' ./feeds/luci/applications/luci-app-accesscontrol/luasrc/controller/mia.lua
